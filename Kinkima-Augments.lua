...
gear.Merl_MB_body = { name="Merlinic Jubbah", augments={'"Subtle Blow"+1','INT+4','Magic burst dmg.+10%',}} --10 MB Dmg, 40 MAB, 40 M.Acc, 10 INT
...
gear.SCH_FC_Cape = { name="Lugh's Cape", augments={'MND+20','MND+10','"Fast Cast"+10','Mag. Evasion+12',}} -- todo: change meva to PDT
