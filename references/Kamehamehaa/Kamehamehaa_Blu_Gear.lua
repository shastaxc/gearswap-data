function user_job_setup()
	...
	state.Weapons:options('SequenceSeq','Sequence','None','Sequence','MagicWeapons','MeleeClubs','MaccWeapons','HybridWeapons')
	...
	send_command('bind ^q gs c weapons Sequence;gs c update')
...
function init_gear_sets()
	...
	sets.precast.Flourish1 = {ammo="Staunch tathlum +1",
	...
	sets.precast.WS.Acc = {ammo="Staunch tathlum +1",
	...
	sets.precast.WS.FullAcc = {ammo="Staunch tathlum +1",
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Staunch tathlum +1",head="Adhemar Bonnet +1",neck="Mirage Stole +2",ear1="Moonshade Earring",ear2="Odr Earring",body="Abnoba Kaftan",hands="Adhemar Wrist. +1",ring2="Begrudging Ring",back=gear.crit_jse_back,feet="Thereoid Greaves"})
	...
	sets.midcast['Blue Magic'].MagicAccuracy = {    main={ name="Nibiru Cudgel", augments={'MP+50','INT+10','"Mag.Atk.Bns."+15',}},
    ammo="Pemphredo Tathlum",
	...
	sets.midcast['Enhancing Magic'] = {main="Vampirism", sub="Vampirism",ammo="Hasty Pinion +1",
		...
		back="Perimede Cape",waist="Siegel sash",legs="Telchine Braconi",feet="Telchine Pigaches"}
	...
	sets.midcast.Cure = {main="Nibiru Cudgel",sub="Bolelabunga",ammo="Pemphredo Tathlum",
		head="Carmine Mask +1",neck="Incanter's Torque",ear1="Etiolation Earring",ear2="Mendi. Earring",
		hands="Telchine Gloves",ring1="Janniston Ring",ring2="Menelaus's Ring",
	...
	sets.midcast['Blue Magic'].Breath = {    main={ name="Vampirism", augments={'STR+3',}},
    sub="Bolelabunga",
	...
	sets.midcast['Blue Magic'].Stun.Resistant = {main="Iris",sub="Iris",ammo="Staunch tathlum +1",
		head="Malignance Chapeau",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Digni. Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back="Cornflower Cape",waist="Olseni Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.midcast['Blue Magic'].Healing = {main="Nibiru Cudgel",sub="Bolelabunga",ammo="Mavi Tathlum",
		head="Carmine Mask +1",neck="Incanter's Torque",ear1="Etiolation Earring",ear2="Mendi. Earring",
	...
	sets.idle = {ammo="Staunch Tathlum +1",
			      head="Rawhide Mask",neck="Loricate Torque +1",ear1="Ethereal earring", ear2="Odnowa earring +1",
			      body="Jhakri Robe +2",hands="nyame gauntlets",ring1="Defending ring",ring2="Gelatinous ring +1",
			      back="moonlight cape",waist="Flume Belt +1",legs="Lengo Pants",feet="Hippo. socks +1"}

	sets.idle.Sphere = set_combine(sets.idle, {body="Mekosu. Harness"})

	sets.idle.PDT = {Main="Almace",Sub="Sequence",
    ammo="Staunch Tathlum +1",
    head="Aya. Zucchetto +2",
    body="Ayanmo Corazza +2",
    hands="Aya. Manopolas +2",
	...
	-- Weapons sets
	sets.weapons.SequenceSeq = {main="Almace",sub="Sequence"}
	sets.weapons.Tizbron = {main="Bolelabunga",sub="Genmei shield"}
	sets.weapons.MeleeClubs = {main="Nehushtan",sub="Nehushtan"}
	sets.weapons.Sequence = {main="Sequence",sub="Sequence"}
	sets.weapons.Sequence = {main="Sequence",sub="Sequence"}
	sets.weapons.Kaja = {main="Naegling",sub="Sequence"}
	...
	sets.engaged = {    main={ name="Almace", augments={'Path: A',}},
    sub="Sequence",
    ammo="Staunch Tathlum +1",
    head="Aya. Zucchetto +2",
    body="Ayanmo Corazza +2",
	...
	sets.engaged.AM = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
	...
	sets.engaged.Acc = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
				head="Dampening Tam",neck="Mirage Stole +2",ear1="Cessance Earring",ear2="Telos Earring",
	...
	sets.engaged.Acc.AM = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
	...
	sets.engaged.FullAcc = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
	...
	sets.engaged.FullAcc.AM = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
			    head="Carmine Mask +1",neck="Mirage Stole +2",ear1="Mache Earring +1",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Assim. Bazu. +3",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
			    back=gear.stp_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet="Malignance Boots"}

	sets.engaged.Fodder = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
	...
	sets.engaged.Fodder.AM = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
			    head="Dampening Tam",neck="Mirage Stole +2",ear1="Dedition Earring",ear2="Telos Earring",
			    body="Adhemar Jacket +1",hands="Adhemar Wrist. +1",ring1="Epona's Ring",ring2="Petrov Ring",
			    back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet="Carmine Greaves +1"}

	sets.engaged.DT = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
	...
	sets.engaged.DT.AM = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Brutal Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.Acc.DT = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
	...
	sets.engaged.Acc.DT.AM = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Digni. Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ilabrat Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.FullAcc.DT = {main="Almace",sub="Sequence",ammo="Staunch tathlum +1",
	...
	sets.engaged.Fodder.DT = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Brutal Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.da_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.Fodder.DT.AM = {main="Almace",sub="Sequence",ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}
