...
function init_gear_sets()
  ...
  sets.precast.WS['Wildfire'] = {
    ...
    head={ name="Herculean Helm", augments={'"Mag.Atk.Bns."+23','Weapon skill damage +3%','AGI+2','Mag. Acc.+7',}},
	body="Lanun Frac +3", --61
    --hands=gear.Nyame_B_hands, --30; WSD
    hands={ name="Herculean Gloves", augments={'STR+1','"Mag.Atk.Bns."+24','Magic burst dmg.+6%','Accuracy+10 Attack+10','Mag. Acc.+17 "Mag.Atk.Bns."+17',}},
	--legs=gear.Nyame_B_legs, --30; WSD
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+16 "Mag.Atk.Bns."+16','Weapon skill damage +2%','Mag. Acc.+4','"Mag.Atk.Bns."+13',}},
	feet="Lanun Bottes +3", --55; WSD
    neck="Commodore Charm +2", --6
    ear1="Friomisi Earring", --10
    ear2="Moonshade Earring", --7
  ...
  --head={ name="Herculean Helm", augments={'Accuracy+20','Weapon skill damage +5%','DEX+1',}},
  ...
  -- legs={ name="Herculean Trousers", augments={'Accuracy+26','Weapon skill damage +4%','DEX+3','Attack+8',}},
	-- feet=gear.Nyame_B_feet,       -- 23, 26, 60, 40, 10, __, ___
    feet={ name="Lanun Bottes +3", augments={'Enhances "Wild Card" effect',}},
	neck="Commodore Charm +2",    -- 12, __, __, __, __, __, ___
