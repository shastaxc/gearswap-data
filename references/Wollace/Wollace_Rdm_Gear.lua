function user_job_setup()
	...
	state.Weapons:options('None','CroceaDW','AE','SavageBlade','CDC','Enspell','BlackHalo','Daybreak','Crocea','Maxentius','EnspellOnly','DualBow')
	...
	gear.TPArrow = "Demon Arrow"
	gear.WSArrow = "Demon Arrow"
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.Enspell = {main="Crocea Mors",sub="Ternion Dagger +1",range=empty,ammo="Hasty Pinion +1",}
	...
	sets.weapons.DualBow = {main="Ternion Dagger +1",sub="Thibron",range="Ullr"}
