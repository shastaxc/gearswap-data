...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {back="Pahtli Cape",feet="Vanya Clogs"})
	...
	sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Achaq Grip",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast.LightWeatherCureSolace = {main="Chatoyant Staff",sub="Achaq Grip",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast.LightDayCureSolace = {main="Chatoyant Staff",sub="Achaq Grip",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast.LightDayCure = {main="Chatoyant Staff",sub="Achaq Grip",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast.LightWeatherCuraga = {main="Chatoyant Staff",sub="Achaq Grip",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast.LightDayCuraga = {main="Queller Rod",
    ammo="Hydrocera",
    head="Kaykaus Mitra",
    body="Ebers Bliaud +1",
    hands="Weath. Cuffs +1",
	...
	sets.midcast['Divine Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Inyanga Jubbah +1",hands="Fanatic Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
	...
	sets.midcast['Dark Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Inyanga Jubbah +1",hands=gear.chironic_enfeeble_hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
	...
	sets.midcast.Stun = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Hasty Pinion +1",
		head="Nahtirah Hat",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Inyanga Jubbah +1",hands="Fanatic Gloves",ring1="Kishar Ring",ring2="Stikini Ring +1",
	...
	sets.idle = {main="Daybreak",sub="Sors Shield",
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		body="Inyanga Jubbah +1",hands=gear.chironic_refresh_hands,ring1="Defending Ring",ring2="Shadow Ring",
    ...
    sets.engaged = {ammo="Staunch Tathlum +1",
		...
		legs="Aya. Cosciales +1",
		feet="Aya. Gambieras +1",
        neck="Asperity Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
		ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back="Kayapa Cape",waist="Windbuffet Belt +1"}
