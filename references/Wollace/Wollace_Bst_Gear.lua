function user_job_setup()
	...
	state.Weapons:options('Decimation','Cloudsplitter','None')
	...
	gear.TPCape = { name="Artio's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Damage taken-5%',}}
	gear.MWSCape = { name="Artio's Mantle", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Weapon skill damage +10%',}}
...
function init_gear_sets()
	...
	sets.precast.JA['Bestial Loyalty'] = {body="Mirke Wardecors",hands="Ankusa Gloves"}
	...
	sets.precast.WS['Cloudsplitter'] = {ammo="Voluspa Tathlum",
    head={ name="Jumalik Helm", augments={'MND+9','"Mag.Atk.Bns."+13','Magic burst dmg.+9%',}},
    body="Meg. Cuirie +1",
    hands={ name="Valorous Mitts", augments={'"Mag.Atk.Bns."+23','"Store TP"+2','Mag. Acc.+16 "Mag.Atk.Bns."+16',}},
    legs={ name="Valorous Hose", augments={'"Mag.Atk.Bns."+17','"Store TP"+2','Quadruple Attack +2','Accuracy+13 Attack+13','Mag. Acc.+19 "Mag.Atk.Bns."+19',}},
    feet={ name="Valorous Greaves", augments={'STR+3','Accuracy+2','Weapon skill damage +9%','Accuracy+11 Attack+11',}},
	...
	sets.midcast.Pet.WS = {main=gear.PHYKumbha1,sub=gear.PHYKumbha2,ammo="Voluspa Tathlum",
		...
		body="Tali'ah Manteel +1",hands="Tali'ah Gages +1",ring1="Varar Ring +1",ring2="Tali'ah Ring",
	...
	sets.idle = {ammo="Staunch Tathlum",
		...
		body="Malignance Tabard",hands="Meg. Gloves +1",ring1="Defending Ring",ring2="Moonbeam Ring",
		back="Moonbeam Cape",waist="Flume Belt",legs="Tali'ah Sera. +1",feet="Malignance Boots"}
	...
	sets.engaged.DW = {ammo="Ginsen",head="Malignance Chapeau",
	...
	sets.weapons.DualWeapons = {main ="Dolichenus",sub="Izizoeksi"}
	sets.weapons.Decimation = {main ="Dolichenus",sub="Ternion Dagger +1"}
	sets.weapons.Cloudsplitter = {main ="Dolichenus",sub="Renaud's Axe +2"}
