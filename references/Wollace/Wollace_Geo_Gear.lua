...
function init_gear_sets()
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		back="Perimede Cape",waist="Embla Sash",legs="Geomancy Pants",feet="Regal Pumps +1"}
	...
	sets.precast.FC.Cure = set_combine(sets.precast.FC, {main="Serenity",sub="Clerisy Strap +1",feet="Vanya Clogs",back="Pahtli Cape"})
    ...
    sets.midcast.Cure = {main="Daybreak",sub="Sors Shield",ammo="Hasty Pinion +1",
        head="Vanya Hood",neck="Nodens Gorget",ear1="Gifted Earring",ear2="Etiolation Earring",
        body="Zendik Robe",hands="Weath. Cuffs +1",ring1="Janniston Ring",ring2="Menelaus's Ring",
        back="Tempered Cape +1",waist="Witful Belt",legs="Geo. Pants +1",feet="Vanya Clogs"}
		
    sets.midcast.LightWeatherCure = {main="Daybreak",sub="Sors Shield",ammo="Hasty Pinion +1",
	...
	sets.idle = {main="Malignance Pole",sub="Achaq Grip",range="Dunna",
    head="Azimuth Hood +1",
    body="Jhakri Robe +2",
    hands="Geo. Mitaines +2",
    legs="Assid. Pants +1",
	...
	sets.idle.Pet = {main="Solstice",sub="Genmei Shield",range="Dunna",
		...
		body="Jhakri Robe +2",hands="Geo. Mitaines +2",ring1="Defending Ring",ring2="Stikini Ring",
		back="Lifestream Cape",waist="Isa Belt",legs="Assid. Pants +1",feet="Bagua Sandals +1"}
