...
function init_gear_sets()
    ...
    legs={ name="Taeon Tights", augments={'Accuracy+7 Attack+7','"Triple Atk."+2','Phalanx +3',}},
	...
	sets.NightIdle = {}
    sets.Knockback = {}
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {head="Volte Cap",legs={ name="Herculean Trousers", augments={'"Fast Cast"+1','Pet: Haste+3','"Treasure Hunter"+1','Accuracy+10 Attack+10','Mag. Acc.+11 "Mag.Atk.Bns."+11',}},waist="Chaac Belt"})
