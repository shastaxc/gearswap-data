...
function user_job_setup()
	...
	state.Weapons:options('Heishi','HeishiAcc','AE','LowBuff','MagicWeapons','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcKatana','ProcClub','ProcStaff')
	state.ExtraMeleeMode = M{['description']='Extra Melee Mode', 'None','SuppaBrutal','DWEarrings','DWMax'}

	gear.wsd_jse_back = { name="Andartia's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}
	gear.tp_jse_back = { name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%',}}
	gear.da_jse_back = { name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10',}}
...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Sapience Orb",
		...
		body="Taeon Tabard",hands="Leyline Gloves",ring1="Weather. Ring",ring2="Kishar Ring",
		legs="Rawhide Trousers",feet="Mochi. Kyahan +3"}
    ...
    sets.precast.WS = {ammo="Cheruski Needle",
        ...
        back=gear.wsd_jse_back,waist="Fotia Belt",legs="Mochi. Hakama +3","Mochi. Kyahan +3"}
   ...
   sets.precast.WS['Blade: Hi'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Yetshila +1",head="Mummu Bonnet +2",ear1="Moonshade Earring",ear2="Trux Earring",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",back=gear.wsd_jse_back,legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +2"})
    ...
    sets.precast.WS['Blade: Shun'] = {ammo="Cheruski Needle",
    ...
    sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {ammo="Cheruski Needle",
    head="Hachiya Hatsu. +3",
    ...
    head="Mochi. Hatsuburi +3",
    body={ name="Herculean Vest", augments={'"Mag.Atk.Bns."+23','Weapon skill damage +5%','Mag. Acc.+12',}},
    hands={ name="Herculean Gloves", augments={'Weapon skill damage +5%','DEX+2','"Mag.Atk.Bns."+9',}},
    legs="Mochi. Hakama +3",
    feet={ name="Herculean Boots", augments={'Pet: "Store TP"+8','Weapon Skill Acc.+9','Weapon skill damage +5%','Accuracy+4 Attack+4','Mag. Acc.+11 "Mag.Atk.Bns."+11',}},
    neck="Ninja Nodowa +1",
    waist="Eschan Stone",
    left_ear="Lugra Earring +1",
    right_ear={ name="Moonshade Earring", augments={'"Mag.Atk.Bns."+4','TP Bonus +250',}},
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        body="Malignance Tabard",hands="Adhemar Wrist. +1",ring1="Defending Ring",ring2="Chirich Ring +1",
        back="Moonlight Cape",waist="Flume Belt +1",legs="Mummu Kecks +2",feet="Malignance Boots"}
	...
	sets.DuskKiting = {feet="Hachiya Kyahan"}
	sets.DuskIdle = {}
	sets.DayIdle = {}
	sets.NightIdle = {}
    ...
    sets.engaged = {ammo="Date shuriken",
        head="Malignance Chapeau",neck="Ninja Nodowa +1",ear1="Enervating Earring",ear2="Telos Earring",
        body="Malignance Tabard",hands="Adhemar Wrist. +1",ring1="Epona's Ring",ring2="Chirich Ring +1",
        back=gear.tp_jse_back,waist="Sailfi Belt +1",legs="Samnuha Tights",feet="Malignance Boots"}
    ...
    sets.engaged.Crit = {ammo="Togakushi Shuriken",
        ...
        back=gear.tp_jse_back,waist="Windbuffet Belt +1",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"}
    ...
    sets.buff.Migawari = set_combine(sets.midcast.FastRecast, {body="Hattori Ningi +1"}) 
	...
	sets.weapons.AE = {main="Tauret",sub="Gokotai"}
	sets.weapons.HeishiAcc = {main="Heishi Shorinken",sub="Gokotai"}
