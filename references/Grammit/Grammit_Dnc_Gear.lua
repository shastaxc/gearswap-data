...
function user_job_setup()
	...
	state.Weapons:options('Ternion','Blurred','TamingSari')
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.Ternion = {main="Tauret",sub="Ternion Dagger +1"}
	sets.weapons.Blurred = {main="Tauret",sub="Blurred Knife +1"}
	sets.weapons.TamingSari = {main="Tauret",sub="Taming Sari"}
    ...
    neck="Fotia Gorget",
    waist="Fotia Belt",
    left_ear={ name="Mache Earring +1", bag="Wardrobe 2", priority=1},
