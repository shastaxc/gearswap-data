function user_job_setup()
	...
	state.Weapons:options('Tizbron','NaeglingCola','NaeglingThib','MagicWeapons','MeleeClubs','MaccWeapons','HybridWeapons','None')
...
function init_gear_sets()
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {head="Jhakri Coronal +2",ear1="Regal Earring",body="Jhakri Robe +2",ring2="Rufescent Ring",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"})
	sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS.Acc, {head="Jhakri Coronal +2",ear1="Regal Earring",ear2="Telos Earring",ring1="Rufescent Ring",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"})
	...
	sets.precast.WS['Realmrazer'] = set_combine(sets.precast.WS, {head="Jhakri Coronal +2",ear1="Regal Earring",body="Jhakri Robe +2",ring2="Rufescent Ring",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"})
	sets.precast.WS['Realmrazer'].Acc = set_combine(sets.precast.WS.Acc, {head="Jhakri Coronal +2",ear1="Regal Earring",ear2="Telos Earring",ring1="Rufescent Ring",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"})
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Cheruski Needle",head="Adhemar Bonnet +1",neck="Mirage Stole +1",
		ear1={ name="Mache Earring +1", bag="Wardrobe 2", priority=1},
		ear2="Odr Earring",body="Malignance Tabard",hands="Adhemar Wrist. +1",feet="Theroid Greaves",ring1="Karieyh Ring",
		ring2="Epona's Ring",back=gear.da_jse_back,feet="Aya. Gambieras +2"})
	sets.precast.WS['Chant du Cygne'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",ear2="Odr Earring",
		ring2="Begrudging Ring",body="Sayadio's Kaftan",back=gear.crit_jse_back,legs="Carmine Cuisses +1"})
	...
	sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",hands="Jhakri Cuffs +2",
		back=gear.wsd_jse_back,waist="Grunfeld Rope",legs="Carmine Cuisses +1",feet=gear.herculean_wsd_feet})
	...
	sets.precast.WS['Expiacion'] = {ammo="Cheruski Needle",
    head={ name="Herculean Helm", augments={'Attack+28','Weapon skill damage +5%','DEX+8',}},
    body="Assim. Jubbah +3",
    hands="Jhakri Cuffs +2",
    legs="Luhlaza Shalwar +3",
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Ghastly Tathlum +1",
			         ...
			         back=gear.nuke_jse_back,waist="Hachirin-no-Obi",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"}
	...
	sets.precast.WS['Seraph Strike'] = {range=empty,ammo="Pemphredo Tathlum",
        head="Jhakri Coronal +2",
    body="Amalric Doublet +1",
    hands="Jhakri Cuffs +2",
    legs="Amalric Slops +1",
	...
	sets.precast.WS['Black Halo'] = {ammo="Cheruski Needle",
    head={ name="Herculean Helm", augments={'Attack+28','Weapon skill damage +5%','DEX+8',}},
    body="Assim. Jubbah +3",
    hands="Jhakri Cuffs +2",
    legs="Luhlaza Shalwar +3",
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Sequence",sub="Almace",ammo="Falcon Eye",
	    ...
	    body="Assim. Jubbah +3",hands="Assim. Bazu. +3",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	    back=gear.da_jse_back,waist="Grunfeld Rope",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"}
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {main="Sequence",sub="Almace",ammo="Falcon Eye",
	   ...
	   back=gear.da_jse_back,waist="Grunfeld Rope",legs="Jhakri Slops +1",feet="Malignance Boots"}
	...
	sets.midcast['Blue Magic'].Magical.Fodder = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		 ...
		 body="Jhakri Robe +2",hands="Amalric Gages +1",ring1="Metamor. Ring +1",ring2="Shiva Ring",
		 back=gear.ElementalCape,waist=gear.ElementalObi,legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"}
    ...
    ear1="Regal Earring",
    ear2="Friomisi Earring",
    ring1={ name="Stikini Ring", bag="Wardrobe 2", priority=1},
    ring2={ name="Stikini Ring +1", bag="Wardrobe 3", priority=2},
    back="Moonlight Cape"}
	
	sets.midcast["Dream Flower"] = {ammo="Ghastly Tathlum +1",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +1",
...
ammo="Staunch Tathlum",
	...
	sets.midcast['Dark Magic'] = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		...
		back=gear.nuke_jse_back,waist="Luminary Sash",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"}
	...
	sets.midcast.Phalanx = set_combine(sets.midcast['Enhancing Magic'],{main="Pukulatmuj +1",head="Taeon Chapeau",neck="Incanter's Torque",ear2="Mimir Earring",
		body="Taeon Tabard",hands="Taeon Gloves",legs="Taeon Tights",feet="Taeon Boots",waist="Olympus Sash"})
	...
	sets.midcast['Elemental Magic'] = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Dosis Tathlum",
		head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
		body="Jhakri Robe +2",hands="Amalric Gages +1",ring1="Shiva Ring",ring2="Shiva Ring",
	...
	sets.midcast['Elemental Magic'].Resistant = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		...
		back=gear.nuke_jse_back,waist="Yamabuki-no-Obi",legs="Jhakri Slops +1",feet="Jhakri Pigaches +2"}
	...
	sets.midcast['Blue Magic']['Healing Fotia'] = sets.midcast['Blue Magic']['White Wind']
	...
	sets.idle.PDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum",
		        ...
		        body="Jhakri Robe +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ayanmo Ring",
	...
	sets.defense.PDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		        ...
		        body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ayanmo Ring",
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {head="Volte Cap",waist="Chaac Belt",legs={ name="Herculean Trousers", augments={'"Fast Cast"+1','Pet: Haste+3','"Treasure Hunter"+1','Accuracy+10 Attack+10','Mag. Acc.+11 "Mag.Atk.Bns."+11',}}})
	...
	sets.weapons.NaeglingCola = {main="Naegling",sub="Colada"}
	sets.weapons.NaeglingThib = {main="Naegling",sub="Thibron"}
	...
	sets.engaged.Acc = {ammo="Ginsen",
		head="Malignance Chapeau",neck="Mirage Stole +1",ear1="Suppanomimi",ear2="Telos Earring",
		body="Malignance Tabard",hands="Adhemar Wrist. +1",ring1="Ilabrat Ring",ring2="Chirich Ring +1",
		back=gear.da_jse_back,waist="Sailfi Belt +1",legs="Carmine Cuisses +1",feet="Malignance Boots"}
