...
function job_setup()
	...
	no_swap_gear = S{"Warp Ring","Caliber Ring", "Emporox's Ring", "Dim. Ring (Dem)", "Dim. Ring (Holla)", "Dim. Ring (Mea)", "Decennial Hose +1",
...
function init_gear_sets()
    ...
    sets.midcast['Blue Magic'].Healing = {
        ...
        ear2="Regal Earring",
        ring1="Gelatinous Ring +1", -- 3
        ring2="Stikini Ring +1", 
        back="Solemnity Cape", --6
        waist="Luminary Sash",
        }
    ...
    sets.magic_burst = set_combine(sets.midcast['Blue Magic'].Magical, {
        ...
        legs="Assim. Shalwar +2", --10
        feet="Amalric Nails +1", --5
        ring1="Mujin Band", --(5)
        back="Seshaw Cape", --5
        })
    ...
    sets.TreasureHunter = {feet="Volte Boots", legs="Volte Hose", head="Volte Cap", waist="Chaac Belt"}
