...
function init_gear_sets()
    ...
    sets.midcast['Magic Finale'] = {neck="Wind Torque",waist="Demonry Sash",legs="Aoidos' Rhing. +2"}
    ...
    sets.midcast.SongEffect = {main="Kali",range="Gjallarhorn",
        ...
        body="Vanya Robe",hands="Aoidos' Manchettes +2",ring1="Prolix Ring",
    ...
    sets.midcast.SongDebuff = {main="Marin Staff",sub="Mephitis Grip",range="Gjallarhorn",
        ...
        body="Vanya Robe",hands="Aoidos' Manchettes +2",ring1="Prolix Ring",ring2="Sangoma Ring",
        back="Kumbira Cape",waist="Demonry Sash",legs="Marduk's Shalwar +1",feet="Brioso Slippers +1"}

    -- For song defbuffs (accuracy primary, duration secondary)
    sets.midcast.ResistantSongDebuff = {main="Marin Staff",sub="Mephitis Grip",range="Gjallarhorn",
    ...
    sets.midcast.Cursna = {
        ...
        hands="Hieros Mittens",ring1="Ephedra Ring",feet="Vanya Clogs"}
