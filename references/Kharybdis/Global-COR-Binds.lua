    ...
    send_command('bind #` input //send safiyeh /ja "Double-Up" <me>')
    ...
    send_command('bind #s input //send safiyeh /ja "Snake Eye" <me>')
    send_command('bind #c input //send safiyeh /ja "Crooked Cards" <me>')
