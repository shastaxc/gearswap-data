...
function user_job_setup()
	...
	state.Weapons:options('None','Aeneas','Fencer','Ternion','LowBuff')
	...
	silibs.enable_auto_lockstyle(43)
...
function init_gear_sets()
	...
	sets.weapons.Fencer = {main="Aeneas",sub="Airy Buckler"}
	sets.weapons.ternion = {main="Aeneas",sub="Ternion dagger +1"}
    -- Precast Sets
