...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {main="Nirvana",
    sub="Elan Strap +1",
    ammo="Epitaph",
    ...
    back={ name="Conveyance Cape", augments={'Summoning magic skill +3','Pet: Enmity+5','Blood Pact ab. del. II -2',}},}
		
    sets.precast.BloodPactRage = {main="Nirvana",
    sub="Elan Strap +1",
    ammo="Epitaph",
    head="Beckoner's Horn +1",
    body="Baayami Robe",
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = { main="Nirvana",
    sub="Elan Strap +1",
    ammo="Epitaph",
    head={ name="Helios Band", augments={'Pet: Accuracy+27 Pet: Rng. Acc.+27','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}},
    body="Con. Doublet +3",
    hands="Convo. Bracers +3",
    legs={ name="Helios Spats", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}},
    feet={ name="Helios Boots", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}},
    ...
    back={ name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: "Regen"+10','Magic dmg. taken-10%',}},}
		
    sets.midcast.Pet.PhysicalBloodPactRage.Acc = {feet="Convo. Pigaches +3"}

    sets.midcast.Pet.MagicalBloodPactRage = {main="Gridarvor",sub="Elan Strap +1",
    ammo="Epitaph",
	...
	sets.midcast.Pet['Flaming Crush'] = {main="Nirvana",
    sub="Elan Strap +1",
    ammo="Epitaph",
    head={ name="Apogee Crown", augments={'MP+60','Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+7',}},
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: Accuracy+12 Pet: Rng. Acc.+12','Blood Pact Dmg.+10','Pet: DEX+3','Pet: Mag. Acc.+5','Pet: "Mag.Atk.Bns."+4',}},
    legs="Baayami Slops",
    ...
    sets.idle.PDT.Avatar = {main="Malignance Pole",sub="Oneiros Grip",ammo="Epitaph",
    ...
    sets.idle.Spirit = {main="Gridarvor",sub="Oneiros Grip",ammo="Epitaph",
    ...
    sets.idle.PDT.Spirit = {main="Malignance Pole",sub="Oneiros Grip",ammo="Epitaph",
