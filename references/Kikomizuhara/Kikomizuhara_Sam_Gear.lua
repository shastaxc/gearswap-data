...
function user_job_setup()
	...
	state.Weapons:options('None','Dojikiri','ProcWeapon','Bow')
...
function init_gear_sets()
	...
	ammo="Knobkierrie",
    head="Mpaca's Cap",
    body={ name="Valorous Mail", augments={'Weapon skill damage +3%','Accuracy+7','Attack+10',}},
    hands={ name="Valorous Mitts", augments={'Accuracy+5','Weapon skill damage +4%','Attack+10',}},
    legs="Hiza. Hizayoroi +2",
    feet={ name="Valorous Greaves", augments={'Attack+4','Weapon skill damage +3%',}},
    neck="Sam. Nodowa +1",
	...
	ammo="Knobkierrie",
    head="Mpaca's Cap",
    body={ name="Valorous Mail", augments={'Accuracy+17','Weapon skill damage +4%','STR+14',}},
    hands={ name="Valorous Mitts", augments={'Weapon skill damage +5%','STR+2','Accuracy+11','Attack+5',}},
    legs="Hiza. Hizayoroi +2",
    feet={ name="Valorous Greaves", augments={'Accuracy+27','Weapon skill damage +4%','AGI+12','Attack+13',}},
   neck="Sam. Nodowa +1",
    waist={ name="Sailfi Belt +1", augments={'Path: A',}},
    left_ear="Thrud Earring",
    right_ear={ name="Moonshade Earring", augments={'Attack+4','TP Bonus +250',}},
    ...
    back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+2','"Store TP"+10','Damage taken-5%',}},}
    ...
    sets.engaged.Fodder.PDT = {ammo="Staunch Tathlum +1",
        ...
        body="Tartarus Platemail",hands="Wakido Kote +3",ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Ioskeha Belt",legs="Wakido Haidate +3",feet="Amm Greaves"}
	sets.engaged.DTLite = {ammo="Aurgelmir Orb",
    head="Nyame Helm",
    body="Nyame Mail",
    hands="Wakido Kote +2",
    legs={ name="Mpaca's Hose", augments={'Path: A',}},
