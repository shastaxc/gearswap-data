...
function user_setup()
    ...
    state.CastingMode:options('Normal', 'Resistant', 'Defensive')
...
function init_gear_sets()
    ...
    sets.midcast['Adventurer\'s Dirge'] = {range="Marsyas", hands="Bihu Cuffs +1"}
    --sets.midcast['Foe Sirvente'] = {head="Bihu Roundlet +1"}
...
-- For song defbuffs (accuracy primary, duration secondary)
    sets.midcast.SongEnhanceTanky = set_combine(sets.midcast.SongEnhancing, {head={ name="Nyame Helm", augments={'Path: B',}},
    body={ name="Nyame Mail", augments={'Path: B',}},
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
    legs={ name="Nyame Flanchard", augments={'Path: B',}},
    feet={ name="Nyame Sollerets", augments={'Path: B',}},})
...
sets.engaged = {
main="Naegling",
    sub="Tauret",--sub={ name="Centovente", augments={'TP Bonus +1000',}},
--main="Tauret",
    --sub="Daybreak",
...
function get_song_class(spell)
    ...
    if set.contains(spell.targets, 'Enemy') then
        ...
        elseif state.CastingMode.value == 'Defensive' then
	    return 'SongEnhanceTanky'
	else
            return 'SongEnfeeble'
        end
