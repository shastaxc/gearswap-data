...
--        ammo="Esper Stone +1", --0/(-5)
        ...
        legs="Atrophy tights +1", --"Kaykaus Tights +1", --11(+2)/(-6)
        feet="Vitiation boots +3", --"Kaykaus Boots +1", --11(+2)/(-12)
--        neck="Incanter's Torque",
--        ear1="Beatific Earring",
--        ear2="Meili Earring",
        ring1="Lebeche ring", --"Haoma's Ring",
...
--        main=gear.Colada_ENH,
--        sub="Ammurapi Shield",
        head="Vitiation chapeau +3", --gear.Telchine_ENH_head,
        body="Viti. Tabard +1",
        hands="Atrophy Gloves +3",
--        legs=gear.Telchine_ENH_legs,
        feet={ name="Telchine Pigaches", augments={'Pet: "Dbl. Atk."+2','Enh. Mag. eff. dur. +7',}}, --feet="Leth. Houseaux +1",
        neck="Dls. Torque +1",
        back="Ghostfyre Cape",
--        waist="Embla Sash",
        }
...
main="Grioavolr", --        main="Daybreak",
sub="Enki Strap", --        sub="Ammurapi Shield",
        ammo="Regal Gem",
        head="Viti. Chapeau +3",
body="Atrophy Tabard +3", --        body="Lethargy Sayon +1",
        hands="Regal Cuffs",
        legs="Merlinic shalwar", --"Chironic Hose",
        feet="Vitiation Boots +3",
        neck="Dls. Torque +1",
        ear1="Rnchanter earring", --"Malignance Earring",
        ear2="Regal earring", --"Snotra Earring",
        ring1="Kishar Ring",
        ring2="Stikini ring +1", --"Metamor. Ring +1",
        back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Phys. dmg. taken-10%',}},
        waist="Luminary Sash",
        }

    sets.midcast.MndEnfeeblesAcc = set_combine(sets.midcast.MndEnfeebles, {
main="Grioavolr", --        main="Crocea Mors",
sub="Clerisy strap +1", --        sub="Ammurapi Shield",
        range="Ullr",
        ammo=empty,
...
main="Grioavolr", --        main="Contemplator +1",
sub="Clerisy strap +1", --        sub="",
        head="Viti. Chapeau +3",
        body="Atrophy Tabard +3",
...
main="Grioavolr", --        main="Rubicundity",
sub="Clerisy strap +1", --        sub="Ammurapi Shield",
        ammo="Pemphredo Tathlum",
        head="Atrophy Chapeau +1",
body="Atrophy Tabard +3", --        body="Carm. Sc. Mail +1",
        hands="Kaykaus Cuffs +1",
        legs="Ea Slops +1",
    ...
    sets.idle = {
        ...
        legs="Ayanmo cosciales +2", --"Volte Brais",
        feet="Volte Gaiters",
        neck="Bathy Choker +1",
        ear1="Eabani Earring",
        ear2="Sanare Earring",
...
--        waist="Acuity Belt +1",
    ...
    sets.engaged = {
        ...
        feet="Merlinic Crackows", --"Carmine Greaves +1",
        neck="Anu Torque",
        ear1="Sherida Earring",
        ear2="Telos Earring",
        ring1="Hetairoi Ring",
