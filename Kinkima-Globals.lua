...
function define_global_sets()
  ...
  gear.Herc_WSD_body = {name="Herculean Vest", augments={'Accuracy+23 Attack+23','Weapon skill damage +4%','DEX+9','Attack+12',}}
  ...
  gear.Telchine_HP_hands = {} -- 50 HP+
  gear.Telchine_HP_legs = {} -- 50 HP+
  ...
  -- Psycloth
  gear.Psycloth_FC_head = { name="Psycloth Tiara", augments={'Mag. Acc.+20','"Fast Cast"+10','INT+7',}}
  gear.Psycloth_FC_legs = { name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}}
