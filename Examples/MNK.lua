...
function init_gear_sets()
    ...
    sets.precast.JA['Chi Blast'] = {
        head="Melee Crown +2",
        body="Otronif Harness +1",hands="Adhemar wristbands +1",
    ...
    sets.precast.JA['Chakra'] = {ammo="Iron Gobbet",
        ...
        back="Iximulew Cape",waist="Caudata Belt",legs="Kendatsuba hakama +1",feet="Thurandaut Boots +1"}

    -- Waltz set (chr and vit)
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Kendatsuba jinpachi +1",
        body="Otronif Harness +1",hands="Hesychast's Gloves +1",ring1="Spiral Ring",
        back="Iximulew Cape",waist="Caudata Belt",legs="Kendatsuba hakama +1",feet="Otronif Boots +1"}
    ...
    sets.precast.WS = {ammo="Thew Bomblet",
        head="Whirlpool Mask",neck="Fotia gorget",ear1="mache earring +1",ear2="Moonshade Earring",
        body="Qaaxo Harness",hands="Anchorite's gloves +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's mantle",waist="Moonbow belt +1",legs="Hizamaru hizayoroi +2",feet="Kendatsuba sune-ate +1"}
    sets.precast.WSAcc = {ammo="Honed Tathlum",body="Manibozho Jerkin",back="Letalis Mantle",feet="Qaaxo Leggings"}
    sets.precast.WSMod = {ammo="Tantra Tathlum",head="Kendatsuba jinpachi +1",legs="Hesychast's Hose +1",feet="Daihanshi Habaki"}
    ...
    sets.precast.WS['Spinning Attack'] = set_combine(sets.precast.WS, {
        head="Kendatsuba jinpachi +1",ear1="Bladeborn Earring",ear2="Steelflash Earring"})
    ...
    sets.idle = {ammo="Thew Bomblet",
        head="Kendatsuba jinpachi +1",neck="Wiglen Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Hesychast's Cyclas",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Hermes' Sandals"}

    sets.idle.Town = {ammo="Thew Bomblet",
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Qaaxo Harness",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Hermes' Sandals"}
    
    sets.idle.Weak = {ammo="Thew Bomblet",
        head="Kendatsuba jinpachi +1",neck="Wiglen Gorget",ear1="Brutal Earring",ear2="Bloodgem Earring",
        body="Hesychast's Cyclas",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Meridian Ring",
        back="Iximulew Cape",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Hermes' Sandals"}
    
    -- Defense sets
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Uk'uxkaj Cap",neck="Lissome necklace",
        body="Otronif Harness +1",hands="Adhemar wristbands +1",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Otronif Boots +1"}

    sets.defense.HP = {ammo="Iron Gobbet",
        head="Uk'uxkaj Cap",neck="Lavalier +1",ear1="Brutal Earring",ear2="Bloodgem Earring",
        body="Hesychast's Cyclas",hands="Adhemar wristbands +1",ring1="K'ayres Ring",ring2="Meridian Ring",
        back="Shadow Mantle",waist="Moonbow belt +1",legs="Hesychast's Hose +1",feet="Hesychast's Gaiters +1"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Uk'uxkaj Cap",neck="Lissome necklace",
        body="Otronif Harness +1",hands="Adhemar wristsbands +1",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Daihanshi Habaki"}
    ...
    -- Normal melee sets
    sets.engaged = {ammo="Hasty Pinion +1",main="",
        head="Ademar bonnet",neck="Lissome necklace",ear1="Mache earring +1",ear2="Cessance earring",
    ...
    sets.engaged.SomeAcc = {ammo="Hasty Pinion +1",main="",
        head="Ademar bonnet",neck="Lissome necklace",ear1="Mache earring +1",ear2="Cessance earring",
        body="Kendatsuba samue +1",hands="Adhemar wristbands +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Kendatsuba sune-ate +1"}
    sets.engaged.Acc = {ammo="Hasty Pinion +1",main="",
        head="Ademar bonnet",neck="Lissome necklace",ear1="Mache earring +1",ear2="Cessance earring",
        body="Kendatsuba samue +1",hands="Adhemar wristbands +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Kendatsuba sune-ate +1"}
    sets.engaged.Mod = {ammo="Hasty Pinion +1",main="",
        head="Ademar bonnet",neck="Lissome necklace",ear1="Mache earring +1",ear2="Cessance earring",
        body="Kendatsuba samue +1",hands="Adhemar wristbands +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Kendatsuba hakama +1",feet="Kendatsuba sune-ate +1"}
    ...
    sets.engaged.PDT = {ammo="Thew Bomblet",
        head="Uk'uxkaj Cap",neck="Lissome necklace",ear1="Bladeborn Earring",ear2="Cessance earring",
        body="Otronif Harness +1",hands="Adhemar wristbands +1",ring1="Patricius Ring",ring2="Epona's Ring",
    ...
    sets.engaged.SomeAcc.PDT = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Ej Necklace",ear1="Bladeborn Earring",ear2="Cessance earring",
        body="Qaaxo Harness",hands="Adhemar wristbands +1",ring1="Patricius Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Anguinus Belt",legs="Hesychast's Hose +1",feet="Anchorite's Gaiters +1"}
    sets.engaged.Acc.PDT = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Lissome necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Otronif Harness +1",hands="Adhemar wristbands +1",ring1="Patricius Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Anguinus Belt",legs="Kendatsuba hakama +1",feet="Qaaxo Leggings"}
    sets.engaged.Counter = {ammo="Thew Bomblet",
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Otronif Harness +1",hands="Adhemar wristbands +1",ring1="K'ayres Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Windbuffet Belt",legs="Anchorite's Hose",feet="Otronif Boots +1"}
    ...
    sets.engaged.Footwork = {ammo="Thew Bomblet",
        head="Kendatsuba jinpachi +1",neck="Monk's nodowa +1",ear1="Mache earring +1",ear2="Cessance earring",
        body="Kendatsuba samue +1",hands="Adhemar wristbands +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Hesychast's Hose +1",feet="Anchorite's Gaiters +1"}
    sets.engaged.Footwork.Acc = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Monk's nodowa +1",ear1="Mache earring +1",ear2="Cessance earring",
        body="Kendatsuba samue +1",hands="Adhemar wristbands +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Moonbow belt +1",legs="Hesychast's Hose +1",feet="Anchorite's Gaiters +1"}
